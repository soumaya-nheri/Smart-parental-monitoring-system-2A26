    ...
    , ui(new Ui::MainWindow)
{
    ...
    QPieSeries *series = new QPieSeries();
       QSqlQuery q("select type,count(*) from site group by type");
...
void MainWindow::on_btn_mail_clicked()
{
    Smtp* smtp = new Smtp("safwen.zakhama@esprit.tn", "safwen","smtp.gmail.com", 465);
        connect(smtp, SIGNAL(status(QString)), this, SLOT(mailSent(QString)));
        smtp->sendMail("safwen.zakhama@esprit.tn",ui->destinataire->text(),ui->objet->text(),ui->message->toPlainText());
}

void MainWindow::on_pushButtondeco_clicked()
{
    hide();
